...
export default function GameCard({ eventGame, canManage, onChanged, onAddRound }: Props) {
  ...
  const typeLabel=eventGame.game?.type==="COOP"?"협력형":eventGame.result_type==="ROLE"?"역할형":eventGame.result_type==="SIMPLE_SCORE"?"등수형":"점수형";
