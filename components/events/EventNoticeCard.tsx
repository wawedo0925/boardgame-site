...
export default function EventNoticeCard({
  ...
  async function sendNotice() {
    ...
    if (!window.confirm("이벤트 참가자에게 이 공지를 보낼까요?")) {
      return;
    }
  ...
  return (
    <section className="h-full rounded-3xl border border-sky-400/20 bg-sky-400/[0.04] p-5 sm:p-6">
          ...
          <div className="border-t border-white/10 pt-5">
            ...
            <div className="mt-3 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-sky-400 px-5 py-3 text-sm font-bold text-zinc-950 disabled:cursor-not-allowed disabled:opacity-40"
              >
