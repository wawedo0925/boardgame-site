...
export type LiveMember = { ghost_vote_used?:boolean; user_id: string; name: string; birth_year?: string | null; seat: number; alive: boolean; actual_role?: string; shown_role?: string; notes?: string };
