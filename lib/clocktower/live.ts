...
export type LiveMission={id:string;round:number;kind:'NUMBERS'|'TEXT'|'SELECT'|'NOTICE';challenge:{tiles?:number[];text?:string;delay_seconds?:number;target_count?:number};completed:boolean};
