...
type EventParticipant = { id: string; user_id: string; participation_role: string; gm_pending: boolean };
type EventRow = {
  id: string;
  title: string;
  started_at: string;
