...
export default function NoticeActions({ id, title, canDelete }: { id: string; title: string; canDelete: boolean }) {
  ...
  return <div className="mt-6">
    <div className="flex flex-wrap gap-3">
      ...
      {canDelete && <form action={action} onSubmit={event => { if (pending || !window.confirm(`‘${title}’ 공지를 삭제할까요?\n삭제한 글은 복구할 수 없습니다.`)) event.preventDefault(); }}>
